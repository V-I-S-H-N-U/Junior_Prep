		...
		$c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=7 & id='.$row['id'] . '"  class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Note</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=9 & id='.$row['id'] . '"  class="dropdown-item "><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Video</a>
                      </li>
                      </ul>
                      </td>
                      ';
		...
		$c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=17 & id='.$row['id'] . '"  class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Note</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=19 & id='.$row['id'] . '"  class="dropdown-item "><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Video</a>
                      </li>
                      </ul>
                      </td>
                      ';
		...
		$c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=27 & id='.$row['id'] . '"  class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Note</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=29 & id='.$row['id'] . '"  class="dropdown-item "><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Video</a>
                      </li>
                      </ul>
                      </td>
                      ';
		...
		$c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=37 & id='.$row['id'] . '"  class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Note</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=39 & id='.$row['id'] . '"  class="dropdown-item "><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Video</a>
                      </li>
                      </ul>
                      </td>
                      ';
		...
		$c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=47 & id='.$row['id'] . '"  class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Note</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['name'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=49 & id='.$row['id'] . '"  class="dropdown-item "><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Video</a>
                      </li>
                      </ul>
                      </td>
                      ';
