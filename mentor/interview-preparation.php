...
while($row=mysqli_fetch_assoc($q))
{
    ...
    ?>
     ...
     <Td><a href="javascript:DeleteNotice('<?php echo $row['id']; ?>')" style='color:Red'><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img"></a></td>
	...
	function DeleteNotice(id)
	{
		...
		{
		window.location.href="interview-preparation.php?int=5 &id="+id;
		}
	}
</script>
...
while($row=mysqli_fetch_assoc($q))
{
        ...
        <Td><a href="javascript:DeleteNotice('<?php echo $row['notice_id']; ?>')" style='color:Red'><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img"></a></td>
	...
	function DeleteNotice(id)
	{
		if(confirm("You want to delete this record ?"))
		{
		window.location.href="interview-preparation.php?int=6 &id="+id;
		}
	}
</script>
