	...
	// exit();
                                ...
                                if(mysqli_num_rows($result) > 0){
                                   ...
                                   if($ps != $cps){
                                    ...
                                    $qil = "UPDATE `users` SET `email`='$em',`password`='$ps',`username`='$us' WHERE username='$d'";
                    ...
                    <div class="card-body">
                        <form action="" method="post" autocomplete="off">
                            <div class="form-group" >
                                ...
                                <input class="form-control" type="text" id="username" name="username" placeholder="<?php echo "{$_SESSION['mentor_name']}";   
                                $d= $_SESSION['mentor_name'];
                                $query1 = "SELECT * FROM users where username='$d'";
