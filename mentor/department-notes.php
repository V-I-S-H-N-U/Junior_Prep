        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['topic'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=4 &id='.$row['sl_no'] . '" onClick=\"javascript: return confirm("Are You Sure?");\" class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Topic</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['topic'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=14 &id='.$row['sl_no'] . '" onClick=\"javascript: return confirm("Are You Sure?");\" class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Topic</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['topic'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=24 &id='.$row['sl_no'] . '" onClick=\"javascript: return confirm("Are You Sure?");\" class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Topic</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['topic'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=34 &id='.$row['sl_no'] . '" onClick=\"javascript: return confirm("Are You Sure?");\" class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Topic</a>
                      </li>
                      </ul>
                      </td>
                      ';
        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['topic'].'</td>';
                      ...
                      <li>
                      <a href="department-notes-action.php?dep=44 &id='.$row['sl_no'] . '" onClick=\"javascript: return confirm("Are You Sure?");\" class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Topic</a>
                      </li>
                      </ul>
                      </td>
                      ';
