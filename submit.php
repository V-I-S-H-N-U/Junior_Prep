<?php
  ...
  if(Token == $_POST['token'])
  {
    ...
    move_uploaded_file($temp_profile,'images2/'.$profile);
...
<div class="grid-container">
  <div class="zone-1">
    <div class="toCenter">
      <img src="images2/<?php echo $profile;?>" class="profile">
    </div>
...
<button onclick="window.print();"style="background-color:blue;">print</button>
        </div>
