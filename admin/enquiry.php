        ...
        $c = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['email'].'</td>';
                      ...
                      <li>
                      <a id="'.$row['id'] . '" onClick="getId(this)" class="dropdown-item"><img src="../assets/img/icons/delete1.svg" class="me-2" alt="img">Delete Enquiry</a>
                      </li>
                      </ul>
                      </td>
                      ';
...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'enq.php?okl=1 &id='+hi,
          fire(
            'success',
