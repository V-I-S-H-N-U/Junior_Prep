...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'arithmetic-notes-action.php?aran=4 &id='+hi,
          fire(
            'success',
...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'arithmetic-notes-action.php?aran=14 &id='+hi,
          fire(
            'success',
...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'arithmetic-notes-action.php?aran=24 &id='+hi,
          fire(
            'success',
...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'arithmetic-notes-action.php?aran=34 &id='+hi,
          fire(
            'success',
...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'arithmetic-notes-action.php?aran=44 &id='+hi,
          fire(
            'success',
...
<script>
     function getId(a)
     {
        ...
        if (result.isConfirmed) {
            window.location.href = 'arithmetic-notes-action.php?aran=54 &id='+hi,
          fire(
            'success',
